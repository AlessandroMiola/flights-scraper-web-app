...
down_revision: Union[str, None] = 'ab7136c2bb1a'
...
def upgrade() -> None:
    ...
    op.add_column(
        'flights', sa.Column('is_two_way_trip', sa.Boolean(), nullable=False)
    )
    op.drop_column('flights', 'is_round_trip')
    op.add_column(
        'parameters',
        sa.Column('is_two_way_trip', sa.Boolean(), nullable=True)
    )
    params = sa.table(
        'parameters',
        sa.Column('is_two_way_trip'),
        sa.Column('is_round_trip')
    )
