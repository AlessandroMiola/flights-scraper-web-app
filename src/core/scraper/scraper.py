...
class EdreamsScraper:
    ...
    def _init_xpaths(self):
        ...
        self._xpath_flight_cards = "//div[contains(@data-testid, 'itinerary') and contains(@class, 'css-1x3sxzl-Box')]"
        self._xpath_line_splitting_subboxes = ".//div[@class='css-pfehrt-Box e17fzqxg0']"
        self._xpath_flight_times = ".//div[contains(@class, 'css-v0s8x5-BaseText-Body')]"
        self._xpath_flight_times_next_days = ".//div[contains(@class, 'css-ql3dpi-BaseText-Body')]"
        self._xpath_flight_locations = ".//div[contains(@class, 'css-1y3uwjk-BaseText-Body')]"
        self._xpath_airlines = ".//div[contains(@class, 'css-1um4vyc-BaseText-Body')]"
        self._xpath_flight_lengths = ".//span[contains(@class, 'css-1mbgvvh-BaseText-Text')]"
        self._xpath_flight_types = ".//span[contains(@class, 'css-1kh4dda-BaseText-Text')]"
        self._xpath_unchecked_luggage = ".//div[contains(@class, 'css-r6p4zw-BaseText-Body')]"
