...
class Flight(Base, TableNameMixin):
    ...
    departure_date_comeback: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    arrival_date_comeback: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    airline: Mapped[str] = mapped_column(String, nullable=False)
    airline_comeback: Mapped[str | None] = mapped_column(String, nullable=True)
    flight_length: Mapped[str] = mapped_column(String, nullable=False)
    flight_length_comeback: Mapped[str | None] = mapped_column(String, nullable=True)
    trip_type: Mapped[str] = mapped_column(String, nullable=False)
    trip_type_comeback: Mapped[str | None] = mapped_column(String, nullable=True)
    price: Mapped[float] = mapped_column(Float, nullable=False)
    currency: Mapped[str] = mapped_column(String, nullable=False)
    luggage_type: Mapped[str] = mapped_column(String, nullable=False)
    luggage_type_comeback: Mapped[str | None] = mapped_column(String, nullable=True)
